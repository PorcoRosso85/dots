...
alias cdfm='cd $(find /mnt/c/Users/admin.DESKTOP-1PF4AT3/ -maxdepth 3 -type d | grep "Documents\|Downloads" | fzf)'
...
#source ~/.bashrcs/neovimpaste.sh
source /root/.extension/forgit/bin/forgit.plugin.sh
